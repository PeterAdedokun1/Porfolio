    ...
    return (
        <ImageSectionStyled>
            ...
            <div className="right-content">
                <h4>I am <span>Adedokun Peter</span></h4>
                <p className="paragraph">
                    ...
                    Eager to tackle more complex problems and continue to find ways to maximize user efficiency. Aspiring to combine broad with strong techincal skills to excel as a Frontend Developer
                ...
                <a href="https://drive.google.com/file/d/1_TdT7aL-COKDZzYRyzkum2HlJSH1xjHG/view"> <PrimaryButton title={'Download Cv'} /> </a>
            </div>
        </ImageSectionStyled>
    )
}
